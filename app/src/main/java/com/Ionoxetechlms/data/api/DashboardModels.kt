...
/**
 * Lesson Item Model
 * Matches PHP payload from course_lesson.php:
 *   { id, course_id, title, description, video_url, lesson_order }
 * Optional batch_id is included for forward-compat if the API later adds it.
 */
 ...
 * Matches PHP payload from course_lesson.php:
 *   { status, course_id, title, description, thumbnail, total_lessons, lessons[] }
 */
